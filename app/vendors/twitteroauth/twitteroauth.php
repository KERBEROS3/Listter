...
class TwitterOAuth {/*{{{*/
  ...
  function http($url, $post_data = null) {/*{{{*/
    ...
    //curlでは、リクエストボディの長さが1024バイトを超える場合、自動的に100-continueが送信される。100-continueを送信しないように抑制
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Expect:'));  //  http://www.escafrace.co.jp/blog/09/10/16/1008
    //////////////////////////////////////////////////
